...
class PurpleModel {
    ...
    var temp: String = ""
    var pressure: String = ""
    var PMcurrent: String = ""
    
    var PM: Double = 0.0
    var PM10min: Double = 0.0
    var PM30min: Double = 0.0
    var PM1hr: Double = 0.0
    var PM6hr: Double = 0.0
    var PM24hr: Double = 0.0
    var PM1week: Double = 0.0
    ...
    var AQDescription: String {
        get {
            return getAQIDescription(aqi: AQ)
        }
    }
    var AQMessage: String {
        get {
    ...
    var AQ10minDescription: String {
        get {
            return getAQIDescription(aqi: AQ10min)
        }
    }
    var AQ10minMessage: String {
        get {
    ...
    var AQ30minDescription: String {
        get {
            return getAQIDescription(aqi: AQ30min)
        }
    }
    var AQ30minMessage: String {
        get {
    ...
    var AQ1hrDescription: String {
        get {
            return getAQIDescription(aqi: AQ1hr)
        }
    }
    var AQ1hrMessage: String {
        get {
    ...
    var AQ6hrDescription: String {
        get {
            return getAQIDescription(aqi: AQ6hr)
        }
    }
    var AQ6hrMessage: String {
        get {
    ...
    var AQ24hrDescription: String {
        get {
            return getAQIDescription(aqi: AQ24hr)
        }
    }
    var AQ24hrMessage: String {
        get {
    ...
    var AQ1weekDescription: String {
        get {
            return getAQIDescription(aqi: AQ1week)
        }
    }
    var AQ1weekMessage: String {
        get {
